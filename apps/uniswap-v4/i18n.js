...
const I18N = {
  en: {
    ...
    close: "Close",
    footnote: "Testnet demo. Tokens are mock AUDD and MMF on Base Sepolia.",
  ...
  ar: {
    ...
    close: "إغلاق",
    footnote: "عرض على شبكة الاختبار. الرموز هي AUDD و MMF وهمية على بيس سيبوليا.",
  ...
  "zh-Hans": {
    ...
    swap_failed: "兑换失败",
    close: "关闭",
    footnote: "测试网演示。代币为 Base Sepolia 上的模拟 AUDD 和 MMF。",
